...
public class AdivinarNumero1 {
    ...
    /**
     * 
     * @return Devuelve el numero introducido por el Juegador 1
     * @throws IOException 
     */
    ...
    /**
     * 
     * @return Devuelve el numero que introduce el Jugador 2
     * @throws IOException 
     */
    ...
    static int adivinarNumero() throws IOException {
        ...
        // Usamos el TRY CATCH para evitar errores si se introduce otro dato que no sea numero
        try {
     ...
     * @return Devuelve un mensaje de texto en funcion de lo cerca que esta el Jugador 2 de acertar el numero.
     */
